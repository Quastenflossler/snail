...
public class OAuthClient {
    ...
    public OAuthClient(final PropertiesClient propertiesClient, JiraOAuthClient jiraOAuthClient) {
...
//                .build();
    ...
    private Optional<Exception> handleUnknownCommand(List<String> arguments) {
        ...
        LOGGER.debug("Command not supported. Only {} are supported.", Command.names());
    ...
    private void parseResponse(HttpResponse response) throws IOException {
        ...
        try {
            ...
            LOGGER.debug("response: {}", jsonObj.toString(2));
        } catch (Exception e) {
